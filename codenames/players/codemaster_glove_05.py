...
class AICodemaster(Codemaster):
    ...
    def get_clue(self):
        ...
        self.cm_wordlist.remove(chosen_clue[1])    #db - here we remove that clue from the option of words we can give
        self.given_clues.add(chosen_clue[1])
